...
def plot_top_reputed_words(text):
    tokens = text.split()
...
if st.button("Analyze"):
    ...
    with col2:
        ...
        st.success("Perplexity Score: {}".format(perplexity))
        st.success("Burstiness score: {}".format(burstiness_score))

        if perplexity > 30000 and burstiness_score < 0.2:
            st.error("Text Analysis Result: AI Generated Content")
        
        else:
            st.success("Text analysis Result: Text likely not generated by AI")

    with col3:
        st.info("Basic Insights")
        plot_top_reputed_words(text_area)
